...
type AcctSummaryOut struct {
	...
	Lmts              struct {
		MatchingEngine         int `json:"matching_engine"`
		MatchingEngineBurst    int `json:"matching_engine_burst"`
		NonMatchingEngine      int `json:"non_matching_engine"`
		NonMatchingEngineBurst int `json:"non_matching_engine_burst"`
	} `json:"limits"`
