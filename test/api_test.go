...
func TestClientSubscribe(t *testing.T) {
	...
	c.On("announcements", func(e *inout.NtfctnAnncmnt) {

	})
	c.On("book.ETH-PERPETUAL.100.1.100ms", func(e *inout.NtfctnOrdrBkGrp) {

	})
	c.On("book.BTC-PERPETUAL.100ms", func(e *inout.NtfctnOrdrBk) {

	})
	c.On("book.BTC-PERPETUAL.raw", func(e *inout.NtfctnOrdrBkRaw) {

	})
	c.On("deribit_price_index.btc_usd", func(e *inout.NtfctnDrbtPrcIndx) {

	})
	c.On("deribit_price_ranking.btc_usd", func(e *inout.NtfctnDrbtPrcRnk) {

	})
	c.On("estimated_expiration_price.btc_usd", func(e *inout.NtfctnEstmtdExprtnPrc) {

	})
	c.On("markprice.options.btc_usd", func(e *inout.NtfctnMrkPrcOptns) {

	})
	c.On("perpetual.BTC-PERPETUAL.raw", func(e *inout.NtfctnPrptl) {

	})
	c.On("quote.BTC-PERPETUAL", func(e *inout.NtfctnQut) {

	})
	c.On("ticker.BTC-PERPETUAL.raw", func(e *inout.NtfctnTckr) {

	})
	c.On("trades.BTC-PERPETUAL.raw", func(e *inout.NtfctnTrades) {

	})

	c.On("user.changes.BTC-PERPETUAL.raw", func(e *inout.NtfctnUserChgs) {

	})
	c.On("user.changes.future.BTC.raw", func(e *inout.NtfctnUserChgs) {

	})
	c.On("user.orders.BTC-PERPETUAL.raw", func(e *inout.NtfctnUserOrdr) {

	})
	c.On("user.orders.future.BTC.100ms", func(e *inout.NtfctnUserOrdr) {

	})
	c.On("user.portfolio.btc", func(e *inout.NtfctnPrtflio) {

	})
	c.On("user.trades.BTC-PERPETUAL.raw", func(e *inout.NtfctnUserTrades) {

	})
	c.On("user.trades.future.BTC.100ms", func(e *inout.NtfctnUserTrades) {
